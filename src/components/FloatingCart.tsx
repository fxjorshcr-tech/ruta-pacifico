...
export default function FloatingCart() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Expanded panel */}
      {open && (
        <div className="w-80 rounded-2xl border border-black/10 bg-white shadow-2xl">
      ...
      <button
        ...
        className="flex items-center gap-2.5 rounded-full bg-sunset-orange px-5 py-3 text-sm font-bold text-white shadow-lg shadow-sunset-orange/30 transition hover:bg-sunset-red hover:shadow-xl"
      >
