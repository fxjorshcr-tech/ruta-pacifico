        ...
        <div className="mt-8 rounded-3xl border border-black/5 bg-white p-6 shadow-sm sm:p-8">
          <div className="mb-6 flex items-center justify-between">
            ...
            <button
              ...
              className="hidden items-center gap-1.5 rounded-full border border-black/10 px-4 py-1.5 text-xs font-medium text-foreground/60 transition hover:border-sunset-orange hover:text-sunset-orange sm:inline-flex"
            >
