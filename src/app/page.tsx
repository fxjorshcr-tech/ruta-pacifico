    ...
    <main>
      ...
      <section id="book" className="bg-white py-20 border-t border-black/5">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-8">
            <a href="https://wa.me/50600000000" className="inline-flex items-center gap-3 rounded-full bg-sunset-orange px-10 py-4 text-base font-semibold text-white transition hover:bg-sunset-gold">
              Book Now
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
              </svg>
