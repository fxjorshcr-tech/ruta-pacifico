...
const longDate = (iso: string, locale: Locale, opts: Intl.DateTimeFormatOptions) =>
  new Date(`${iso}T12:00:00Z`).toLocaleDateString(INTL_LOCALE[locale], {
    ...opts,
    timeZone: "UTC",
  });
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: localeAlternates("/about-contact", locale),
    openGraph: {
      title: t.ogTitle,
      description: t.ogDescription,
      locale: OG_LOCALE[locale],
      url: localeUrl(locale, "/about-contact"),
    },
  };
}
...
export default async function AboutContactPage({ params }: { params: Params }) {
  const locale = await localeFromParams(params);
  const t = ABOUT[locale];
  // "May 2026" / "mayo de 2026"
  const launchLabel = longDate(BRAND_LAUNCH, locale, { month: "long", year: "numeric" });
    ...
    <main className="min-h-screen bg-light-surface">
      ...
      <section className="relative flex min-h-[45vh] items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl px-6 pt-24 pb-20 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-white/75">{t.heroSub(ICT_LICENSE)}</p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-6xl px-6 pb-24 pt-12">
        ...
        <section className="grid gap-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
            ...
            <p className="mt-4 leading-relaxed text-foreground/70">{t.aboutP1}</p>
            <p className="mt-4 leading-relaxed text-foreground/70">{t.aboutP2}</p>
            <p className="mt-4 leading-relaxed text-foreground/70">
              {t.founderBefore(FOUNDER.name, FOUNDER.inTourismSince)}
              <a
              ...
              {t.founderAfter(SISTER_BRAND.region, launchLabel)}
            </p>
              ...
              <div className="mt-5 space-y-4 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-foreground/50">{t.basedInCountry}</div>
                  </div>
                </div>
        ...
        <div className="mt-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-foreground/60">{t.touchSub}</p>
        </div>
          ...
          >
            ...
            <div className="relative flex items-start gap-5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-2 text-sm text-foreground/60">{t.whatsapp.desc}</p>
              </div>
              <svg
          ...
          >
            ...
            <div className="relative flex items-start gap-5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-2 text-sm text-foreground/60">{t.email.desc}</p>
              </div>
              <svg
        ...
        <section className="mt-5 grid gap-5 lg:grid-cols-2">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm text-foreground/60">{t.instagram.desc}</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm text-foreground/60">{t.facebook.desc}</p>
            </div>
          </a>
        </section>
        ...
        <section className="mt-14 overflow-hidden rounded-3xl bg-gradient-to-br from-sunset-red via-sunset-orange to-sunset-gold p-[1px]">
          <div className="relative rounded-[calc(1.5rem-1px)] bg-foreground p-8 text-center sm:p-12">
            ...
            <p className="relative mx-auto mt-3 max-w-xl text-sm text-white/70">{t.cta.sub}</p>
          ...
          <div className="inline-flex items-center gap-3 rounded-2xl border border-black/5 bg-white px-5 py-3 shadow-sm">
            ...
            <div className="text-left leading-tight">
              <div className="text-sm font-bold text-foreground">
                {t.badgeLicensed(ICT_LICENSE)}
              </div>
              <div className="text-xs text-foreground/50">{t.badgeBoard}</div>
            </div>
          </div>
        </div>
      </div>
